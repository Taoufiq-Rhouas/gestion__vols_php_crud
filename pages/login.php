...
<html lang="en">
    ...
    <body>
        ...
        <center>
            <h1>
                <?php 
                    // if(isset($_SESSION['resultat_login'])){
                        echo $_SESSION['resultat_login'];
                        $_SESSION['resultat_login'] = '';
                    // }
                ?>
            </h1>
        </center>
            ...
            <div class="row mx-md-n5">
                <div class="col px-md-5" id="form1">
                    <div class="p-3 border bg-light">
                        <h1>1</h1>
                        <form class="needs-validation" method='POST' action='login_submit.php?statut=User'>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="motpass" class="form-control" id="Motpass1" placeholder="you@example.com" required>
                            </div><br>
                            <!-- <div class="mb-3">
                ...
                <div class="col px-md-5" id="form2">
                    <div class="p-3 border bg-light">
                        <H1>2</H1>
                        <form class="needs-validation" method='POST' action='login_submit.php?statut=Admin'>
                            ...
                            <div class="mb-3">
                                <label for="text">Mot De Pass :</label>
                                <input type="text" name="motpass" class="form-control" id="Motpass2" placeholder="you@example.com" required>
                            </div><br>
                            <!-- <div class="mb-3">
                                <label for="text">Confermer Le Mot De Pass :</label>
